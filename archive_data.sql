...
CREATE TABLE BOOKS_DETAILS (
    ...
    TotalCopies INT DEFAULT NULL CHECK (
        TotalCopies > 0
...
-- STAFF
INSERT INTO
    STAFF (StaffID, Name, Email, Role, Username, Password)
VALUES
    (
        1,
        'David Brown',
...
VALUES
    ...
    (5, 4, 4, '2024-04-10', '2023-04-24', NULL),
    (
        6,
        5,
        5,
    ...
    (7, 7, 7, '2024-04-14', '2023-04-28', NULL),
    (8, 8, 8, '2024-04-15', '2023-04-29', NULL),
    (
        9,
        9,
        9,
    ...
    (2, 2, 3, '2024-04-20', '2023-04-27', NULL),
    (11, 10, 10, '2024-12-01', '2024-12-15', NULL),
    (3, 1, 2, '2024-12-03', '2024-12-17', NULL);
...
-- FINE_STATUS
INSERT INTO
    FINE_STATUS (FineId, MemberId, FineStatus)
VALUES
    (1, 2, 'Paid'),
    (2, 1, 'Unpaid'),
    (3, 3, 'Paid'),
...
FROM
    LOANS
    JOIN BOOK_INVENTORY ON LOANS.BookId = BOOK_INVENTORY.BookId
    JOIN BOOKS_DETAILS ON BOOK_INVENTORY.ISBN = BOOKS_DETAILS.ISBN
    JOIN MEMBERS ON LOANS.MemberId = MEMBERS.MemberId
ORDER BY
    BOOKS_DETAILS.Title ASC,
    LOANS.LoanDate ASC;
...
FROM
    BOOKS_DETAILS BD
    LEFT JOIN RESERVATIONS R ON BD.ISBN = (
        SELECT
            BI.ISBN
        FROM
            BOOK_INVENTORY BI
...
FROM
    BOOKS_DETAILS BD
    RIGHT JOIN RESERVATIONS R ON BD.ISBN = (
        SELECT
            BI.ISBN
        FROM
            BOOK_INVENTORY BI
...
SELECT
    DISTINCT BD.Title AS BookTitle
FROM
    BOOKS_DETAILS BD
    JOIN BOOK_INVENTORY BI ON BD.ISBN = BI.ISBN
    ...
    SUM(f.FineAmount) = (
        ...
        FROM
            (
                SELECT
                    MemberId,
                    SUM(FineAmount) AS MemberTotalFine
                FROM
                    FINES
                GROUP BY
                    MemberId
...
WHERE
    L.LoanDate >= DATE_SUB(CURDATE(), INTERVAL 30 DAY)
ORDER BY
    M.Name,
    BD.Title;
